**Note: the items in bold are learning goals that require you to apply your
knowledge to a software QA scenario, rather than simply recalling knowledge,
and hence may need more preparation.**

## TESTING THEORY AND TERMINOLOGY
* Be able to explain why exhaustive testing is virtually impossible, even with just one method.
* Be able to differentiate between explicit and implicit boundary values.
...
* Be able to define all terminology introduced or fill in the blank.
* **Be able to write a test case with preconditions, execution steps, and postconditions given a testing scenario.**
* **Be able to write a forward/hackward traceability matrix given requirements and test cases.**

## DEFECT REPORTING
* Be able to explain how to differentiate between a defect and a candidate for enhancement.
* Be able to explain whether a violation of implicit requirements is a defect.
* Be able to define all terminology introduced or fill in the blank.
